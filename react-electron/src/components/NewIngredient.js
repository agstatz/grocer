 ...
 const NewIngredient = ({ingredients, handleChange}) => {
    ...
    const updateIngredient = () => {
        ...
        if (validateIngredient(value)) {
            ...
            currentIngredients.push({ingredient: value,
                                       meal: null});
    ...
    return (
        <>
        {
            ...
            : mode === "full" ? <li>{ingredient}<Button icon="edit" onClick={setEditMode}></Button></li> : <Input size="mini" id="newIngredientInput" placeholder='Add an Ingredient' action={{ icon: 'plus', onClick: updateIngredient }} ></Input>
        }
